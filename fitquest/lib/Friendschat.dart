    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
                ...
                Pinned.fromPins(
                  ...
                  child: Stack(
                    children: <Widget>[
                      ...
                      Pinned.fromPins(
                        Pin(startFraction: 0.1047, endFraction: 0.0883),
          ...
          Pinned.fromPins(
            Pin(startFraction: 0.5, endFraction: 0.0973),
          ...
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromPins(
                  Pin(startFraction: 0.1017, endFraction: 0.2977),
                  Pin(size: 15.0, middle: 0.2147),
                  child: Text(
                    'Okie, see you soon ',
                    style: TextStyle(
                      fontFamily: 'Montserrat',
                ...
                Align(
                  alignment: Alignment(0.485, -0.523),
                  child: SizedBox(
                    width: 11.0,
                    height: 11.0,
                    child: Stack(
                      children: <Widget>[
                        ...
                        Align(
                          alignment: Alignment(-0.228, -0.228),
                          child: SizedBox(
                            width: 1.0,
                            height: 1.0,
                            child: SvgPicture.string(
                        ...
                        Align(
                          alignment: Alignment(0.434, -0.228),
                          child: SizedBox(
                            width: 1.0,
                            height: 1.0,
                            child: SvgPicture.string(
          ...
          Pinned.fromPins(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                borderRadius:
                    BorderRadius.all(Radius.elliptical(9999.0, 9999.0)),
                border: Border.all(width: 4.0, color: const Color(0x7dffffff)),
              ),
            ),
          ),
          Pinned.fromPins(
...
const String _svg_nbua5s =
    '<svg viewBox="3.0 3.0 10.7 10.7" ><path  d="M 13.70752048492432 8.353759765625 C 13.70752048492432 11.31055927276611 11.31055927276611 13.70752048492432 8.353759765625 13.70752048492432 C 5.396959781646729 13.70752048492432 3 11.31055927276611 3 8.353759765625 C 3 5.396959781646729 5.396959781646729 3 8.353759765625 3 C 11.31055927276611 3 13.70752048492432 5.396959781646729 13.70752048492432 8.353759765625 Z" fill="none" stroke="#ffca6e" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" /></svg>';
const String _svg_rc2ga3 =
    '<svg viewBox="6.2 9.4 4.3 1.1" ><path transform="translate(-5.79, -11.58)" d="M 12 21 C 12 21 12.80306339263916 22.07075119018555 14.14150333404541 22.07075119018555 C 15.47994327545166 22.07075119018555 16.28300857543945 21 16.28300857543945 21" fill="none" stroke="#ffca6e" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" /></svg>';
const String _svg_qawyy =
    '<svg viewBox="6.7 6.7 1.0 1.0" ><path transform="translate(-6.75, -6.75)" d="M 13.5 13.5 L 13.5053539276123 13.5" fill="none" stroke="#ffca6e" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" /></svg>';
const String _svg_rakew8 =
    '<svg viewBox="10.0 6.7 1.0 1.0" ><path transform="translate(-12.54, -6.75)" d="M 22.5 13.5 L 22.5053539276123 13.5" fill="none" stroke="#ffca6e" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" /></svg>';
