          ...
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Align(
                  alignment: Alignment(-0.331, -0.242),
                  child: SizedBox(
                    width: 38.0,
                    height: 38.0,
                    child: SvgPicture.string(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromPins(
                  ...
                  child: Text(
                    'The beginner mode allows you to see friends nearby a location\nyou searched, identified as a black dot on the map.',
                    style: TextStyle(
                      fontFamily: 'Open Sans',
                      fontSize: 10,
                      color: const Color(0xff000000),
...
const String _svg_bnz70m =
    '<svg viewBox="117.0 349.0 38.0 38.0" ><path transform="translate(117.0, 349.0)" d="M 19 0 C 29.493408203125 0 38 8.506590843200684 38 19 C 38 29.493408203125 29.493408203125 38 19 38 C 8.506590843200684 38 0 29.493408203125 0 19 C 0 8.506590843200684 8.506590843200684 0 19 0 Z" fill="none" stroke="#ffffff" stroke-width="3" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
